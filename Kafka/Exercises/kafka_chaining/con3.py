...
for message in consumer3:
    ## change the code below using the function moving_average above
    producer.send(operator4_topic, message)
    ##
    if received_messages == 8:  # Note: Change this to match the number of messages you expect
        break                   # after applying the filter operator, ewma, and moving average
